...
{{< accordion title="Speaker Qualifications" >}}
...
{{< accordion title="Choosing a Topic" >}}
...
- Talk Title:
- Elevator Pitch: Two sentences to sell your talk.
- Format, Choose One: Regular (~40 min) / Lightning (~5 min) / Workshop (>hour).
- Audience Level: Beginner / Intermediate / Advanced
- Description (Markdown Preferred):
- Notes (informational only, not published):
- Speaker Name:
- Speaker URL:
- Shirt Size:
- Speaker Bio:
